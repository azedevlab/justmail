...
// Side-effect-free schema module: importing it never touches process.env, so
// tooling (the .env.example generator) and tests can introspect the shape
// without triggering the fail-fast load in config.ts.
